...
{
    [TestFixture]
    public class ChangePasswordNoNumber
    {
        ...
        [Test]
        public void TheChangePasswordNoNumberTest()
        {
            ...
            Assert.AreEqual("Passwords must have at least one digit ('0'-'9').", driver.FindElement(By.XPath("//form/div/ul/li")).Text);
