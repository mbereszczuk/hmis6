...
{
    [TestFixture]
    public class ChangePasswordNoUppercaseLetter
    {
        ...
        [Test]
        public void TheChangePasswordNoUppercaseLetterTest()
        {
            ...
            Assert.AreEqual("Passwords must have at least one uppercase ('A'-'Z').", driver.FindElement(By.XPath("//form/div/ul/li")).Text);
