...
{
    [TestFixture]
    public class ChangePasswordNoSpecialSign
    {
        ...
        [Test]
        public void TheChangePasswordNoSpecialSignTest()
        {
            driver.Navigate().GoToUrl("https://loginhmis2018vs2017.azurewebsites.net/");
            driver.FindElement(By.Id("loginLink")).Click();
            driver.FindElement(By.Id("Email")).Clear();
            driver.FindElement(By.Id("Email")).SendKeys("mb@ual.es");
            ...
            Assert.AreEqual("Passwords must have at least one non letter or digit character.", driver.FindElement(By.XPath("//form/div/ul/li")).Text);
