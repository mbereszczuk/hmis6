...
{
    [TestFixture]
    public class ChangePasswordWrongNewPassword
    {
        ...
        [Test]
        public void TheChangePasswordWrongNewPasswordTest()
        {
            ...
            driver.FindElement(By.Id("OldPassword")).SendKeys("Abc123\"");
            driver.FindElement(By.Id("NewPassword")).Clear();
            driver.FindElement(By.Id("NewPassword")).SendKeys("NewPass1!");
            driver.FindElement(By.Id("ConfirmPassword")).Clear();
            driver.FindElement(By.Id("ConfirmPassword")).SendKeys("NewPass1!a");
            driver.FindElement(By.XPath("//input[@value='Cambiar contraseña']")).Click();
            Assert.AreEqual("La contraseña nueva y la contraseña de confirmación no coinciden.", driver.FindElement(By.XPath("//form/div/ul/li")).Text);
